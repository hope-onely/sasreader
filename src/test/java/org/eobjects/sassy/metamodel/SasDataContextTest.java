...
public class SasDataContextTest extends TestCase {
	...
	public void testPaging() throws Exception {
		...
		TableModel tm;
		tm = dc.executeQuery(q).toTableModel();
	...
	public void testResourcesFolder() throws Exception {
		...
		assertEquals(
				"Column[name=brand,columnNumber=8,type=VARCHAR,nullable=true,indexed=false,nativeType=null,columnSize=1]",
				table.getColumnByName("brand").toString());
		assertEquals(
				"Column[name=id,columnNumber=0,type=VARCHAR,nullable=true,indexed=false,nativeType=null,columnSize=5]",
				table.getColumnByName("id").toString());
		assertEquals(
				"Column[name=mois,columnNumber=1,type=NUMERIC,nullable=true,indexed=false,nativeType=null,columnSize=8]",
